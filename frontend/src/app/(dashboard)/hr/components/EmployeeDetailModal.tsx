...
const getRoleBadgeColor = (roleType: string) => {
 ...
 DRIVER: 'bg-accent-100 text-accent-strong border-accent-subtle',
...
export function EmployeeDetailModal({ open, onOpenChange, employee, onEdit }: EmployeeDetailModalProps) {
 ...
 >
 {/* Header */}
 <div className="flex items-center justify-between p-6 border-b bg-accent-gradient">
 ...
 {onEdit && (
 <Button onClick={handleEdit} className="bg-accent-gradient to-purple-600 hover:from-pink-600 hover:to-purple-700">
