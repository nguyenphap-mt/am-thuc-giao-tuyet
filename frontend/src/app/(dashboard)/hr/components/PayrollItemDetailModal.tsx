...
export default function PayrollItemDetailModal({
 ...
 <Badge className={item.is_fulltime ? 'bg-accent-100 text-accent-strong' : 'bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300'}>
 ...
 <p className="font-bold text-accent-primary">{item.overtime_hours.toFixed(1)}h</p>
 </div>
 <div className="text-center p-2 bg-white rounded-lg">
 ...
 <span className="font-medium text-accent-primary">{formatCurrency(item.overtime_pay)}</span>
 </div>
 <div className="flex justify-between">
