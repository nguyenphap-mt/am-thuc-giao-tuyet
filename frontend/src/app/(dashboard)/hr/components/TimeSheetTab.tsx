...
export default function TimeSheetTab() {
 ...
 { label: 'Đã ra', value: stats.checked_out, icon: IconLogout, bgColor: 'bg-accent-50', iconColor: 'text-accent-primary' },
 ].map((stat, i) => (
 ...
 <>
 <span>•</span>
 <span className="text-accent-primary font-medium">{assignment.order_code}</span>
 </>
 )}
 </div>
 </div>
 ...
 className={quickFilter === 'today' ? 'bg-accent-gradient to-purple-500 text-white' : ''}
 >
 Hôm nay
 </Button>
 <Button
 ...
 className={quickFilter === 'week' ? 'bg-accent-gradient to-purple-500 text-white' : ''}
 >
 Tuần này
 </Button>
 <Button
 ...
 className={quickFilter === 'month' ? 'bg-accent-gradient to-purple-500 text-white' : ''}
 >
 Tháng này
 </Button>
 </div>
 ...
 size="sm"
 className={quickFilter === 'custom' ? 'bg-accent-gradient to-purple-500 text-white' : ''}
 >
 ...
 <div className="grid grid-cols-2 lg:grid-cols-5 gap-4 px-4 py-3 bg-accent-50 to-pink-50 border-y">
 <div>
 ...
 <p className="font-bold text-lg text-accent-primary">{timesheets.reduce((sum, ts) => sum + ts.overtime_hours, 0).toFixed(1)}h</p>
 </div>
 <div>
 ...
 {ts.overtime_hours > 0 && (
 <p className="text-xs text-accent-primary">+{ts.overtime_hours.toFixed(1)} OT</p>
 )}
 </div>
 ...
 <div className="h-12 w-12 rounded-full bg-accent-gradient-br to-purple-500 flex items-center justify-center text-white font-medium text-lg">
 ...
 <p className="font-bold text-lg text-accent-primary">{selectedTimesheet.overtime_hours.toFixed(1)}h</p>
 </div>
 </div>
