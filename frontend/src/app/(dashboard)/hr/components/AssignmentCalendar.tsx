...
const STATUS_COLORS: Record<string, string> = {
 ...
 'CHECKED_IN': 'bg-accent-100 text-accent-strong border-accent-subtle',
...
export default function AssignmentCalendar({
 ...
 ${isTodayDate ? 'ring-2 ring-accent ring-offset-1' : 'border-gray-200 dark:border-gray-700'}
 `}
 >
 ...
 <div className={`
 text-sm font-medium
 ${isTodayDate ? 'text-accent-primary' : isSunday ? 'text-red-500' : 'text-gray-700 dark:text-gray-300'}
 `}>
 {format(day, 'd')}
 </div>
 </div>
