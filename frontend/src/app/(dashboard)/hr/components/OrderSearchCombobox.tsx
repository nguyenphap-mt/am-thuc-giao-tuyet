...
export function OrderSearchCombobox({
 ...
 <span className="text-accent-primary font-medium text-xs bg-accent-50 px-1.5 py-0.5 rounded">
 ...
 <div key={dateKey}>
 {/* Date Header */}
 <div className="sticky top-0 bg-accent-50 px-3 py-1.5 text-xs font-semibold text-accent-strong flex items-center gap-2 border-b border-accent-subtle">
 <IconCalendar className="h-3.5 w-3.5" />
 {getDateLabel(dateKey)}
 <span className="text-accent-muted font-normal">({dateOrders.length})</span>
 </div>
 ...
 value === order.id && "bg-accent-50"
 )}
 >
 {/* Check icon */}
 <div className="w-5 flex items-center justify-center pt-0.5">
 {value === order.id && (
 <IconCheck className="h-4 w-4 text-accent-primary" />
 )}
 </div>
 ...
 <div className="flex items-center gap-2">
 <span className="text-accent-primary font-medium text-xs bg-accent-100 px-1.5 py-0.5 rounded">
 {formatTime(order)}
 </span>
