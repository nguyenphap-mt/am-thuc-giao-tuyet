...
export function BudgetManagement() {
 ...
 <IconCalendarDollar className="h-6 w-6 text-accent-primary" />
 ...
 className="h-10 px-3 rounded-md border border-gray-200 dark:border-gray-700 bg-white text-sm focus:ring-2 focus:ring-accent"
 >
 ...
 <Button className="bg-accent-gradient to-blue-600 hover:from-purple-600 hover:to-blue-700">
 ...
 <Card className="bg-accent-50 to-blue-50">
 <CardContent className="p-4">
 <div className="text-sm text-gray-600 dark:text-gray-400">Tổng ngân sách</div>
 <div className="text-2xl font-bold text-accent-strong">{formatCurrency(totalBudgeted)}</div>
 </CardContent>
 </Card>
