...
export function MenuAnalytics({ engineeringData, topSellers, categoryBreakdown }: MenuAnalyticsProps) {
 ...
 idx < 3 ? 'bg-accent-gradient to-purple-500 text-white' : 'bg-gray-100 text-gray-600'
 )}>{item.rank}</span>
 <div className="flex-1 min-w-0">
 ...
 <div className="h-full bg-accent-gradient rounded-full transition-all" style={{ width: `${barWidth}%` }} />
 </div>
