...
export function RecipeDrawer({
 ...
 <SheetHeader>
 <SheetTitle className="flex items-center gap-2"><IconChefHat className="h-5 w-5 text-accent-primary" />Công thức</SheetTitle>
 ...
 <button key={inv.id} onClick={() => handleSelectIngredient(inv)} className="w-full flex items-center gap-3 px-3 py-2 hover:bg-accent-50 text-left transition-colors cursor-pointer" disabled={addPending}>
 ...
 className="w-full flex items-center justify-center gap-2 px-3 py-2 rounded-md border border-dashed border-accent-medium bg-accent-50 hover:bg-accent-100 text-accent-strong text-sm font-medium transition-colors cursor-pointer"
 >
 ...
 <Button
 size="sm" className="flex-1 h-8 text-xs bg-accent-solid text-white"
 onClick={async () => {
 ...
 <div className="border-2 border-accent-subtle rounded-lg p-3 bg-accent-50 space-y-2.5">
 {/* P4+P5: Selected ingredient header with better X button */}
 <div className="flex items-center gap-2">
 <div className="p-1.5 rounded bg-accent-100 shrink-0">
 <IconReceipt className="h-4 w-4 text-accent-primary" />
 </div>
 <div className="flex-1 min-w-0">
 ...
 <Button
 size="sm" className="flex-1 h-9 text-sm bg-accent-solid text-white gap-1"
 ...
 <IconArrowUp className="mx-auto h-5 w-5 text-accent-muted" />
 </div>
 ...
 onUpdateIngredient ? 'hover:bg-accent-50 cursor-pointer group/edit' : ''
 )}
