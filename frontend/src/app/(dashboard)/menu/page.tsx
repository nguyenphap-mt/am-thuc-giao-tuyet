...
export default function MenuPage() {
 ...
 <Button className="w-full sm:w-auto bg-accent-gradient" onClick={handlePrimaryAdd}>
 ...
 { label: 'Danh mục', value: stats?.total_categories ?? '-', icon: IconCategory, bg: 'bg-accent-50', ic: 'text-accent-primary' },
