...
export default function ProfilePage() {
 ...
 <AvatarFallback className="text-3xl md:text-4xl bg-accent-gradient-br text-white font-bold">
 ...
 className="absolute bottom-1 right-1 rounded-full h-10 w-10 bg-white border-2 border-accent-medium shadow-lg hover:bg-accent-50 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
 >
 <IconCamera className="h-4 w-4 text-accent-primary" />
 </Button>
 </div>
 ...
 <Badge className="mt-2 bg-accent-gradient text-white">
 ...
 <IconUser className="h-5 w-5 text-accent-primary" />
 Thông tin cá nhân
 </CardTitle>
 ...
 <CardHeader className="pb-3">
 <CardTitle className="text-base flex items-center gap-2">
 <IconLock className="h-5 w-5 text-accent-primary" />
 Đổi mật khẩu
 </CardTitle>
 ...
 className={`h-10 pr-10 focus-visible:ring-accent ${passwordErrors.current ? 'border-red-300' : ''}`}
 />
 <button
 type="button"
 ...
 onKeyDown={handlePasswordKeyDown}
 className={`h-10 pr-10 focus-visible:ring-accent ${passwordErrors.new ? 'border-red-300' : ''}`}
 />
 <button
 type="button"
 ...
 onKeyDown={handlePasswordKeyDown}
 className={`h-10 pr-10 focus-visible:ring-accent ${passwordErrors.confirm ? 'border-red-300' : ''}`}
 />
 <button
 type="button"
 ...
 <CardHeader className="pb-3">
 <CardTitle className="text-base flex items-center gap-2">
 <IconFingerprint className="h-5 w-5 text-accent-primary" />
 Xác thực 2 lớp (2FA)
 </CardTitle>
 <CardDescription className="text-sm">Tăng cường bảo mật tài khoản</CardDescription>
 </CardHeader>
 <CardContent>
 <div className="flex items-center justify-between p-4 rounded-lg bg-accent-50 dark:bg-accent-100 border border-accent-subtle dark:border-accent-strong">
 <div className="flex items-center gap-4">
 <div className="h-12 w-12 rounded-xl flex items-center justify-center bg-accent-100 dark:bg-accent-200">
 <IconShield className="h-6 w-6 text-accent-muted" />
 </div>
 <div>
 ...
 <Badge variant="outline" className="text-xs text-accent-primary border-accent-subtle">Sắp ra mắt</Badge>
 ...
 <div>
 <CardTitle className="text-base flex items-center gap-2">
 <IconHistory className="h-5 w-5 text-accent-primary" />
 Lịch sử hoạt động
 </CardTitle>
 ...
 <p className="text-xs text-accent-primary dark:text-accent-muted mt-0.5">
 {formatActivityDetail(activity)}
 </p>
 )}
 ...
 <div>
 <CardTitle className="text-base flex items-center gap-2">
 <IconDevices className="h-5 w-5 text-accent-primary" />
 Lịch sử đăng nhập
 </CardTitle>
