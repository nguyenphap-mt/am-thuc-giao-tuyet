...
const getCategoryColor = (cat: string) => {
 ...
 case 'EQUIPMENT': return 'bg-accent-100 text-accent-strong';
...
export default function SupplierTab() {
 ...
 <Button size="sm" className="h-8 bg-accent-gradient text-white" onClick={openCreate}>
 ...
 <Button className="bg-accent-gradient" onClick={handleSubmit} disabled={createMutation.isPending || updateMutation.isPending}>
