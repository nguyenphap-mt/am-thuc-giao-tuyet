...
export default function CalendarPage() {
 ...
 className="bg-accent-gradient text-white hover:opacity-90 text-xs"
 >
 ...
 className={`text-xs ${showStaffPanel ? 'bg-accent-solid text-white' : ''}`}
 >
 ...
 <Button variant="ghost" size="sm" onClick={goToToday} className="text-xs text-accent-primary hover:text-accent-strong">
 Hôm nay
 </Button>
 </div>
...
function MonthView({
 ...
 ${isTodayCell ? 'bg-accent-50 border-accent-medium ring-1 ring-accent-light' : 'border-gray-200 dark:border-gray-700'}
 ...
 <span className={`text-xs font-semibold tabular-nums ${isTodayCell ? 'text-accent-primary' : 'text-gray-700 dark:text-gray-300'}`}>
 {day}
 </span>
 {hasConflict && (
