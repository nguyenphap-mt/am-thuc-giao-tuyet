...
export function DayView({ currentDate, events, isLoading, onEventClick }: DayViewProps) {
 ...
 <div className={`text-center p-3 rounded-xl min-w-[60px] ${isToday ? 'bg-accent-100' : 'bg-gray-100 dark:bg-gray-800'}`}>
 <p className={`text-2xl font-bold tabular-nums ${isToday ? 'text-accent-primary' : 'text-gray-900 dark:text-gray-100'}`}>
 {currentDate.getDate()}
 </p>
