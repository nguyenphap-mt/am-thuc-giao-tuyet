...
const loyaltyColors: Record<string, string> = {
 ...
 platinum: 'bg-accent-100 text-accent-strong border-accent-medium',
};
...
export function CustomerDetailModal({ customerId, open, onOpenChange }: CustomerDetailModalProps) {
 ...
 <div className="h-11 w-11 rounded-full bg-accent-gradient-br to-purple-500 flex items-center justify-center text-white font-bold text-lg shadow-md">
 ...
 <p className="text-lg font-bold text-accent-strong">{formatNumber(totalQuotes)}</p>
 <p className="text-[10px] text-accent-primary">Báo giá</p>
 </div>
 ...
 <div className="space-y-3">
 {/* Current Tier Card */}
 <Card className="border-2 border-accent-subtle bg-accent-50">
 ...
 <div
 className="bg-accent-gradient to-purple-500 h-2.5 rounded-full transition-all duration-500"
 ...
 <div className="space-y-3">
 <Card className="border border-accent-subtle bg-accent-50">
 <CardContent className="p-5 text-center">
 <IconCoin className="h-10 w-10 mx-auto text-accent-muted" />
 ...
 <Card className="mb-3 border-dashed border-accent-subtle bg-accent-50">
 ...
 <Button
 size="icon"
 className="h-8 w-8 bg-accent-solid shrink-0"
 ...
 <div className="absolute left-2 w-5 h-5 rounded-full bg-accent-100 border-2 border-accent-medium flex items-center justify-center">
 ...
 ? 'bg-accent-100 text-accent-strong ring-1 ring-accent-light'
 ...
 .map(opt => (
 <Badge key={opt.key} className="bg-accent-100 text-accent-strong text-xs">
 {opt.label}
 </Badge>
 ))
 }
