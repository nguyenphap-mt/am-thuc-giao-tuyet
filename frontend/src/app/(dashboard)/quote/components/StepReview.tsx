...
export function StepReview({ state, onGoToStep }: Props) {
    ...
    const editLink = (step: number, label: string) => onGoToStep ? (
        <button type="button" onClick={() => onGoToStep(step)}
            className="text-xs text-accent-primary hover:text-accent-strong ml-2 underline">Sửa {label}</button>
    ) : null;
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="border rounded-lg p-4">
                ...
                <Select value={selectedQuoteNote} onValueChange={(value) => {
                    ...
                    <SelectContent>
                        ...
                        <SelectItem value="__custom__" className="text-accent-primary font-medium">✏️ Nhập ghi chú khác...</SelectItem>
                    </SelectContent>
                </Select>
                ...
                {selectedQuoteNote && selectedQuoteNote !== '__custom__' && (
                    <p className="mt-2 text-sm text-gray-600 dark:text-gray-400 bg-accent-50 p-2 rounded">
            ...
            <div className="border rounded-lg overflow-hidden">
                <div className="bg-accent-50 to-pink-50 px-4 py-3 border-b">
                    <h4 className="font-semibold text-gray-900 flex items-center gap-2">
                        <IconToolsKitchen2 className="h-5 w-5 text-accent-primary" />
                            ...
                            <div className="overflow-x-auto">
                                <table className="w-full text-sm">
                                    ...
                                    <tfoot>
                                        ...
                                        <tr className="bg-accent-50 border-t-2 border-accent-subtle">
                                            <td colSpan={2} className="py-3 px-3 font-bold text-accent-strong">TỔNG THỰC ĐƠN ({tableCount} bàn):</td>
                                            <td className="py-3 px-3 text-right font-bold text-accent-strong">{formatCurrency(profitAnalysis.totalSelling)}</td>
                        ...
                        <dl className="space-y-3 text-sm">
                            ...
                            <div className="border-t pt-3 mt-3">
                                <div className="flex items-center gap-2 mb-3">
                                    <IconDiscount className="h-4 w-4 text-accent-primary" />
                            ...
                            {/* Grand Total */}
                            <div className="border-t-2 border-accent-subtle pt-4 mt-3 bg-accent-50 to-pink-50 -mx-4 px-4 pb-4 rounded-b-lg">
                                <div className="flex justify-between text-xl font-bold">
                                    <dt className="text-accent-strong">TỔNG CỘNG:</dt>
                                    <dd className="text-accent-primary">{formatCurrency(grandTotal)}</dd>
                                </div>
                            </div>
                        </dl>
                    </div>
