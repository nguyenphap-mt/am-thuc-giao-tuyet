...
// Display settings for output (PDF/Excel/Print)
export type MenuPriceDisplay = 'detailed' | 'name_only' | 'summary';
export type ServicePriceDisplay = 'detailed' | 'summary';
...
export interface WizardState {
    ...
    // Display settings (for PDF/Excel/Print output)
    menuPriceDisplay: MenuPriceDisplay;
    setMenuPriceDisplay: React.Dispatch<React.SetStateAction<MenuPriceDisplay>>;
    servicePriceDisplay: ServicePriceDisplay;
    setServicePriceDisplay: React.Dispatch<React.SetStateAction<ServicePriceDisplay>>;
