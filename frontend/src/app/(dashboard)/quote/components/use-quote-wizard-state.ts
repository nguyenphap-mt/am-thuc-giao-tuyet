...
export function useQuoteWizardState(initialFormData?: FormData): WizardState {
    ...
    const [menuPriceDisplay, setMenuPriceDisplay] = useState<MenuPriceDisplay>('detailed');
    const [servicePriceDisplay, setServicePriceDisplay] = useState<ServicePriceDisplay>('detailed');
