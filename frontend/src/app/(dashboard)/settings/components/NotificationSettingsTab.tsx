...
const CHANNELS = [
 { key: 'inapp' as const, label: 'In-App', desc: 'Thông báo trong ứng dụng', icon: IconBell, color: 'bg-accent-100 dark:bg-accent-200', iconColor: 'text-accent-primary' },
...
export default function NotificationSettingsTab() {
 ...
 <IconBell className="h-5 w-5 text-accent-primary" />
 ...
 ? 'border-accent-medium bg-accent-50 dark:bg-accent-200 dark:border-accent-medium'
 ...
 ? 'border-accent-medium bg-accent-solid'
 : 'border-gray-300 dark:border-gray-600'
 }`}
 >
 {isActive && <div className="w-1.5 h-1.5 rounded-full bg-white" />}
 </div>
 <span className={`text-sm font-medium ${isActive ? 'text-accent-strong dark:text-accent-muted' : 'text-gray-700 dark:text-gray-300'}`}>
 {opt.label}
 </span>
 </div>
 ...
 className="px-3 py-1.5 text-sm rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 dark:text-gray-200 focus:ring-2 focus:ring-accent/20 focus:border-accent-medium outline-none"
 />
 </div>
