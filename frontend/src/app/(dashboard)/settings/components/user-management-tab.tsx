...
export function UserManagementTab() {
 ...
 className="h-10 bg-accent-gradient hover:opacity-90 transition-opacity whitespace-nowrap"
 >
 ...
 <p className="text-sm text-gray-400 dark:text-gray-500 mt-1">Thử thay đổi bộ lọc hoặc tạo tài khoản mới</p>
 </div>
 ) : (
 ...
 variant="ghost"
 size="icon"
 className="h-8 w-8 text-gray-500 dark:text-gray-400 hover:text-accent-primary hover:bg-accent-50"
