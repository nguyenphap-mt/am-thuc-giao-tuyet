...
const PERMISSION_MODULES = [
    ...
    { module: 'hr', label: 'Nhân sự', actions: ['view', 'create', 'edit', 'delete', 'view_salary', 'process_payroll'] },
...
const ACTION_TOOLTIPS: Record<string, string> = {
    ...
    view_salary: 'Cho phép xem thông tin lương',
    process_payroll: 'Cho phép chạy tính lương',
