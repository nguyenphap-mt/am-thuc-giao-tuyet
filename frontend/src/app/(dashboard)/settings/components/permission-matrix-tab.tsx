...
export function PermissionMatrixTab() {
 ...
 <div className="h-10 w-10 rounded-lg bg-accent-gradient-br flex items-center justify-center">
 ...
 className="pl-10 h-10 bg-white focus-visible:ring-accent"
 />
 {searchQuery && (
 <button
 ...
 className="h-3.5 w-3.5 data-[state=checked]:bg-accent-solid data-[state=checked]:border-accent-strong"
 />
 </div>
 </TooltipTrigger>
 ...
 hover:bg-accent-50/30 transition-colors group
 `}
 style={aIdx === 0 ? {
 borderLeftWidth: '3px',
 ...
 <td className={`p-3 sticky left-0 bg-white group-hover:bg-accent-50/30 z-10 transition-colors ${aIdx === 0 ? 'font-medium text-gray-900 dark:text-gray-100' : 'text-gray-400 dark:text-gray-500 text-xs pl-8'}`}>
 {aIdx === 0 ? (
 ...
 <td className="p-3 text-gray-600 dark:text-gray-400 text-xs sticky left-[200px] bg-white group-hover:bg-accent-50/30 z-10 transition-colors">
 <Tooltip>
 <TooltipTrigger asChild>
 ...
 ? 'text-accent-primary hover:text-accent-strong'
 : moduleSomeChecked
 ? 'text-accent-muted hover:text-accent-primary'
 ...
 className="data-[state=checked]:bg-accent-solid data-[state=checked]:border-accent-strong"
 />
 </div>
 </td>
 );
 ...
 <IconLock className="h-4 w-4 text-accent-muted" />
 </div>
 ) : (
 <div className="flex items-center justify-center">
 <Checkbox
 ...
 exit={{ opacity: 0, y: 20 }}
 className="fixed bottom-6 right-6 bg-accent-gradient text-white px-4 py-2.5 rounded-lg shadow-lg flex items-center gap-3 z-50"
 >
