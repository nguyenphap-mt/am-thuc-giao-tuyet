...
export function AssignedStaffCard({
 ...
 >
 {/* Header */}
 <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800 bg-accent-50 to-pink-50">
 <div className="flex items-center gap-2">
 <div className="p-2 rounded-lg bg-white shadow-sm">
 <IconUsers className="w-5 h-5 text-accent-primary" aria-hidden="true" />
 </div>
 <div>
 ...
 className="border-accent-subtle text-accent-primary hover:bg-accent-50 hover:border-accent-medium"
 >
 ...
 {/* Staff Row */}
 <div
 className="group relative flex items-center gap-4 p-3 rounded-lg border border-gray-100 dark:border-gray-800 hover:border-accent-subtle hover:bg-accent-50/30 transition-all cursor-pointer"
 ...
 {isEditing && (
 <div className="ml-16 mt-2 p-3 bg-accent-50 rounded-lg border border-accent-subtle animate-in slide-in-from-top-2 duration-200">
 <p className="text-xs font-medium text-accent-strong mb-2">Sửa giờ phân công</p>
 ...
 className="px-2 py-1.5 text-sm border border-gray-200 rounded-md focus:ring-2 focus:ring-accent-light focus:border-accent-medium outline-none"
 />
 </div>
 <div className="flex items-center gap-2">
 ...
 {editHours > 0 && (
 <span className="text-xs text-accent-primary font-medium bg-accent-100 px-2 py-1 rounded-full">
 ...
 className="h-7 text-xs bg-accent-solid text-white"
 >
