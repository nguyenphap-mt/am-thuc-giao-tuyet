 ...
 */
 ...
 <IconLoader2 className="w-8 h-8 text-accent-primary animate-spin" aria-hidden="true" />
 </div>
 )}
 ...
 ${selectedStaff.has(staff.employee_id) ? 'border-accent-medium bg-accent-50' : 'border-gray-200 hover:border-accent-subtle hover:bg-gray-50'}
 ...
 ${selectedStaff.has(staff.employee_id) ? 'bg-accent-solid border-accent-medium' : 'border-gray-300'}
 ...
 {/* Avatar */}
 <div className="w-10 h-10 rounded-full bg-accent-gradient-br to-pink-400 flex items-center justify-center text-white font-bold">
 ...
 className={`shrink-0 ${expandedStaffId === staff.employee_id ? 'bg-accent-solid text-white' : ''}`}
 >
 ...
 >
 <div className="border border-t-0 border-accent-medium bg-accent-50 rounded-b-lg p-4">
 <div className="flex items-center gap-3 flex-wrap">
 <div className="flex items-center gap-1.5 text-sm text-gray-600">
 <IconCalendar className="w-4 h-4 text-accent-primary" />
 <input
 type="date"
 value={assignDate}
 onChange={(e) => setAssignDate(e.target.value)}
 className="border border-accent-subtle rounded-lg px-3 py-1.5 text-sm bg-white focus:ring-2 focus:ring-accent-light focus:border-accent-medium outline-none"
 onClick={(e) => e.stopPropagation()}
 />
 </div>

 <div className="flex items-center gap-2">
 <IconClock className="w-4 h-4 text-accent-primary" />
 ...
 className="bg-accent-gradient to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white"
 >
 ...
 Chi phí ước tính: <span className="font-medium text-accent-primary">{new Intl.NumberFormat('vi-VN').format(staff.hourly_rate * individualHours)}đ</span>
 ...
 value={assignDate}
 onChange={(e) => setAssignDate(e.target.value)}
 className="border border-gray-200 rounded-lg px-3 py-1.5 text-sm bg-white focus:ring-2 focus:ring-accent-light focus:border-accent-medium outline-none"
 />
 <input
 type="time"
 value={bulkStartTime}
 ...
 className="bg-accent-gradient to-pink-500 hover:from-purple-600 hover:to-pink-600"
 >
 {assignMutation.isPending ? (
