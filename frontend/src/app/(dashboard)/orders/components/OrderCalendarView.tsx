...
export default function OrderCalendarView({ orders }: OrderCalendarViewProps) {
 ...
 {/* Header */}
 <div className="flex items-center justify-between p-4 border-b bg-accent-50 to-pink-50">
 ...
 {/* Month summary */}
 <div className="flex items-center justify-between p-3 border-t bg-accent-50 to-pink-50 text-sm">
