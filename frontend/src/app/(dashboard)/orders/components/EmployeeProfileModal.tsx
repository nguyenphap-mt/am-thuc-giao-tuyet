...
export function EmployeeProfileModal({
 ...
 >
 {/* Header */}
 <div className="sticky top-0 bg-accent-gradient to-pink-500 text-white p-4 z-10">
 ...
 {/* Profile Header */}
 <div className="flex items-center gap-4">
 <div className="w-16 h-16 rounded-full bg-accent-gradient-br to-pink-500 flex items-center justify-center text-white text-2xl font-bold shadow-lg">
 ...
 <IconBriefcase className="w-4 h-4 text-accent-primary" aria-hidden="true" />
 </div>
 <div>
