...
export function FloatingActionButton({ actions, className }: FloatingActionButtonProps) {
 ...
 "cursor-pointer",
 action.color || "bg-accent-gradient to-purple-600 text-white hover:from-pink-700 hover:to-purple-700 focus:ring-accent"
 )}
 ...
 "bg-accent-gradient to-purple-600 text-white",
