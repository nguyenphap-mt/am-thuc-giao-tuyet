...
export function AddPaymentModal({
 ...
 <IconCreditCard className="h-5 w-5 text-accent-primary" />
 Thêm Thanh Toán
 </DialogTitle>
 <DialogDescription>
 ...
 variant="link"
 size="sm"
 className="p-0 h-auto text-accent-primary"
 ...
 isSelected
 ? 'border-accent-medium bg-accent-50'
 : 'border-gray-200 hover:bg-gray-50'
 )}
 >
 <Icon className={cn(
 'h-5 w-5',
 isSelected ? 'text-accent-primary' : 'text-gray-600'
 )} />
 <span className={cn(
 'text-xs font-medium',
 isSelected ? 'text-accent-strong' : 'text-gray-700'
 )}>{method.label}</span>
 </button>
 );
 })}
