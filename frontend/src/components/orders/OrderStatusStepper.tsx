...
export function OrderStatusStepper({ currentStatus }: OrderStatusStepperProps) {
 ...
 isCompleted && 'bg-accent-gradient to-purple-500 text-white',
 isCurrent && !isOnHold && 'bg-accent-gradient to-purple-500 text-white ring-4 ring-pink-100',
 ...
 index < currentStep
 ? 'bg-accent-gradient to-purple-500'
 : 'bg-gray-200'
 )}
 />
 </div>
 ...
 isCompleted && 'bg-accent-gradient to-purple-500 text-white',
 isCurrent && !isOnHold && 'bg-accent-gradient to-purple-500 text-white',
