...
# NOTE: Leave management endpoints are defined above in PHASE 5 (line ~2277-3085).
# A duplicate section was removed here (BUG-20260217-004) that was causing 500 errors
# due to schema validation mismatches from FastAPI's last-handler-wins behavior.
